...
import TicketCreationScreen from '../screens/User/TicketCreationScreen'; // ✅ добавь
...
export default function UserNavigator() {
  return (
    <Tab.Navigator initialRouteName="Map"
      screenOptions={({ route }) => ({
        tabBarIcon: ({ color, size }) => {
          ...
          else if (route.name === 'TicketCreation') iconName = 'add-circle-outline';
    ...
    >
      ...
      <Tab.Screen name="Tickets" component={TicketListScreen} options={{ title: 'Tickets' }} />
